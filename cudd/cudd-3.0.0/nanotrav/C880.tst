...
Number of cache look-ups: 59168
Number of cache hits: 28640
Number of cache insertions: 30607
Number of cache collisions: 2559
Number of cache deletions: 28048
Cache used slots = 18.12% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 20.95% (expected 20.96%)
...
Maximum resident size            =  5796K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1604
Swaps = 0
Input blocks = 0
Output blocks = 8
